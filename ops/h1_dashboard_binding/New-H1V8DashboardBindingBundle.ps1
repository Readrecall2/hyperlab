...
$InputPath = Join-Path $PSScriptRoot 'binding-input-v8.json'
...
if ($LASTEXITCODE -ne 0) { throw 'Frozen V8 dashboard binding input refused.' }

New-Item -ItemType Directory -Path $OutputRoot | Out-Null
$BundlePath = Join-Path $OutputRoot 'hyperlab-h1-v8-dashboard-binding-v1.bundle'
...
if ($LASTEXITCODE -ne 0) { throw 'H1 V8 dashboard binding finalization failed.' }
...
Write-Output 'H1_V8_DASHBOARD_BINDING_WINDOWS_BUNDLE_FINALIZED_NOT_TRANSFERRED'
