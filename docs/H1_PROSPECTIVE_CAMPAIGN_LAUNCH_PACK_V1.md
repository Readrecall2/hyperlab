...
`H1_PROSPECTIVE_CAMPAIGN_LAUNCH_PACK_V1_GREEN_AWAITING_HUMAN_VPS_EXECUTION`.
...
The campaign is armed for `2026-08-27T19:00:00Z`. Complete the human transfer
and systemd installation no later than `2026-08-27T18:30:00Z`. Before the
...
4. unique incoming/source/campaign roots under `/home/hyperlab/hyperlab-h1`;
5. exact detached commit and clean clone;
6. synchronized NTP, safe ownership, and free bytes greater than the remaining
