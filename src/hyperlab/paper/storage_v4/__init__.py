"""Authenticated Storage v4 core with dependency-isolated public exports.

The package facade is lazy so importing a stdlib-only Storage v4 submodule does
not initialize Golden/backtest dependencies that it does not use.
"""
