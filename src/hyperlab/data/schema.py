...
_V1_SPECS = (
    ...
    _make_spec(
        ...
        [
            ...
            _field("response_cloudfront_pop", pa.string(), nullable=True),
            _field("response_cache", pa.string(), nullable=True),
            _field("request_boundary_monotonic_elapsed_ms", MARKET_DECIMAL, nullable=True),
            _field("request_boundary_thread_cpu_ms", MARKET_DECIMAL, nullable=True),
            _field("request_boundary_thread_runqueue_wait_ms", MARKET_DECIMAL, nullable=True),
            _field("request_boundary_thread_timeslice_delta", pa.uint64(), nullable=True),
            _field("requests_session_request_ordinal", pa.uint64(), nullable=True),
            _field("urllib3_connection_observed_age_ms", MARKET_DECIMAL, nullable=True),
            _field("tls_socket_observed_age_ms", MARKET_DECIMAL, nullable=True),
        ],
        primary_key=("venue", "observation_id"),
        order_key=("event_time", "received_time", "observation_id"),
        version=4,
